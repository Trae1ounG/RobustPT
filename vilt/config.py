...
def config():
    ...
    missing_type = {'train': 'text', 'val': 'text', 'test': 'text'} # ['text', 'image', 'both'] in VL tasks
    print(f"missing_type:{missing_type}")
    both_ratio = 0.5   # missing both ratio
    missing_table_root = '/home/user/keshi3/PromptAgent/datasets/missing_tables/'
    simulate_missing = False
    
    # missing_aware_prompts config
    prompt_type = 'head' # ['head', 'cross'] in VL tasks
